...
console.log(changed
  ? '[Security/Data] API interna fechada por padrão, envios manuais identificados e diagnóstico público aplicado.'
  : '[Security/Data] Proteções da API interna e diagnóstico público já estavam aplicados.');
