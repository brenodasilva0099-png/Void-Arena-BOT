...
if (!src.includes("const { getPublicPanelAudit } = require('./publicPanelRefresh');")) {
  replaceOnce(
    "const { extractDiscordMessageAttachments } = require('./discordClient');",
